"""
Yield-curve-only training: **hierarchical encoder + OU Neural SDE** (diagonal noise).

Run from the repo root:

    python -m experiments_fra.one_model_experiments_on_YC.YC_HierEnc_OUNSDE
"""
import os
...
def main() -> None:
    ...
    trainer_cfg.run_name = "YC_HOU_v1"
