"""
Yield-curve-only training: **hierarchical encoder + simple Neural SDE** (diagonal noise).

Run from the repo root:

    python -m experiments_fra.one_model_experiments_on_YC.YC_HierEnc_SimpleNSDE
"""
import os
...
def main() -> None:
    ...
    # -------------------------------------------------------------------
    # Hierarchical encoder: fast LSTM + slow GRU, concat-combined
    # -------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------
    # Trainer — hierarchical encoders need fast/slow lookbacks
    # -------------------------------------------------------------------
    trainer_cfg = TrainerCfg()
    trainer_cfg.run_name = "YC_HS_v1"
