"""
Yield-curve-only training: **hierarchical encoder + Vasicek-style NSDE** (diagonal noise).

OU drift + constant diffusion — the neural analogue of the Vasicek model
with a richer (hierarchical) encoder front-end.

Run from the repo root:

    python -m experiments_fra.one_model_experiments_on_YC.YC_HierEnc_VasicekNSDE
"""
import os
...
def main() -> None:
    ...
    trainer_cfg.run_name = "YC_HVas_v1"
