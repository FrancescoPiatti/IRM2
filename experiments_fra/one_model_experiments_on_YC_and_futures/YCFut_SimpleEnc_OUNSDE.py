...
Configuration:
- simple encoder
- **OU** Neural SDE under risk-neutral Q (diagonal noise, mean-reverting drift)
- SimpleBondNet for the CTD futures pricer

Run from the repo root:

    python -m experiments_fra.one_model_experiments_on_YC_and_futures.YCFut_SimpleEnc_OUNSDE
"""
import os
...
def main() -> None:
    ...
    trainer_cfg.run_name = "YCFut_SOU_v1"
